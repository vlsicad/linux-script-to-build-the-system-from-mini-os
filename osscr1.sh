...
(cd $HOME/nos && \
    cp chroot/boot/vmlinuz-4.4.0-21-generic image/live/vmlinuz1
    cp chroot/boot/initrd.img-4.4.0-21-generic image/live/initrd1
)
